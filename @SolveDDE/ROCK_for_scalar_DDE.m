...
function K = find_K(y_n, s, obj, n, K, t, m)
    K(t, 1) = y_n;
    c = zeros(1, s+1);
    c(1) = 0;
    ...
    c(2) = w_1 / w_0;
    delayed_K_2 = find_K_in_past(obj, K, t, m, c, 2);
    K(t, 2) = y_n + obj.h * w_1 / w_0 * obj.func(K(t, 1), delayed_K_2);

    for i = 2:s
        c(i+1) = 2 * chebyshevT(i-1, w_0) / chebyshevT(i, w_0) * (w_1 + w_0*c(i-1)) - ...
             chebyshevT(i-2, w_0) / chebyshevT(i, w_0) * c(i-1);
        delayed_K_i = find_K_in_past(obj, K, t, m, c, i);
